...
function App() {
  ...
  const toggleMode = () => {
    if (mode === 'light') {
      ...
      document.getElementsByClassName('button').style.backgroundColor = '#6c757d'; // Change button background color
      document.getElementsByTagName('button').style.color = '#f8f9fa';
    } else {
      setMode('light');
