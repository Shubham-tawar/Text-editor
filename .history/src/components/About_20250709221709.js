            ...
            <div className="row gx-4 align-items-center justify-content-between">
                ...
                <div className="col-md-6 offset-md-1 order-1 order-md-2">
                    <div className="row gx-2 gx-lg-3">
                        <div className="col-6">
                            <div className="mb-2"><img className="img-fluid rounded-3" src="https://freefrontend.dev/assets/square.png" alt=''/></div>
                        </div>
                        <div className="col-6">
                            <div className="mb-2"><img className="img-fluid rounded-3" src="https://freefrontend.dev/assets/square.png" alt=''/></div>
                        </div>
                        <div className="col-6">
                            <div className="mb-2"><img className="img-fluid rounded-3" src="https://freefrontend.dev/assets/square.png" v/></div>
                        </div>
                        <div className="col-6">
