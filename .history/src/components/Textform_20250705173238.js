...
export default function Textform(props) {
    ...
    function handleOnChange(event){ // I am able to change teh text in the textarea
    ...
    return (
        <form className='container my-3'>       
            ...
            <div className="form-group">
                ...
                <textarea className="form-control" id="exampleFormControlTextarea1" onChange={handleOnChange} rows="3" value={text} placeholder='Text Area'></textarea>
            </div>
