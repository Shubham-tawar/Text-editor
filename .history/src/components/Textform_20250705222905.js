...
export default function Textform(props) {
    ...
    return (
        ...
        <form className='container my-3'>       
            ...
            <button type='button' className="btn btn-danger" onClick={handleLowClick}>lowecase</button>
            <button type='button' className="btn btn-success" onClick={handleSnakeClick}>snake-click</button>
        </form>
